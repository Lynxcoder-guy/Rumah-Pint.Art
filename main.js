...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.services .dropdown a').forEach(link => {
    link.addEventListener('click', e => {
      // Prevent page reload for empty/placeholder links
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (c1_h3) c1_h3.innerHTML = 'Cimol Cinere';
  ...
  if (c2_h3) c2_h3.innerHTML = 'Cimol Cinere';
  ...
  if (c3_h3) c3_h3.innerHTML = 'Cimol Cinere';
});